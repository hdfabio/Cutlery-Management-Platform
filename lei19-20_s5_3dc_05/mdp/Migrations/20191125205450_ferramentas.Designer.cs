...
namespace mdp.Migrations
{
    ...
    [Migration("20191125205450_ferramentas")]
            ...
            modelBuilder.Entity("mdp.Model.Operacao", b =>
                {
                    ...
                    b.OwnsOne("mdp.Model.ValueObjects.Ferramenta", "Ferramenta", b1 =>
                        {
                            b1.Property<Guid>("OperacaoId");
                            ...
                            b1.HasOne("mdp.Model.Operacao")
                                .WithOne("Ferramenta")
                                .HasForeignKey("mdp.Model.ValueObjects.Ferramenta", "OperacaoId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
